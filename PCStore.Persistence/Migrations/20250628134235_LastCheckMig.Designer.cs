...
namespace PCStore.Persistence.Migrations
{
    ...
    [Migration("20250628134235_LastCheckMig")]
    partial class LastCheckMig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.Discount", b =>
                {
                    b.HasOne("PCStore.Domain.Entities.Product", null)
                        .WithMany("Discounts")
                        .HasForeignKey("ProductId");
                });
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.DiscountUsage", b =>
                {
                    ...
                    b.HasOne("PCStore.Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("PCStore.Domain.Entities.DiscountUsage", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
