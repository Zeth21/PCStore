...
namespace PCStore.Persistence.Migrations
{
    ...
    [Migration("20250624122425_OrderProductPriceUpdate")]
    partial class OrderProductPriceUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.ShoppingCart", b =>
                {
                    b.HasOne("PCStore.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("PCStore.Domain.Entities.ShoppingCart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.ShoppingCartItem", b =>
                {
                    ...
                    b.HasOne("PCStore.Domain.Entities.ShoppingCart", "ShoppingCart")
                        .WithMany("Items")
