...
namespace PCStore.Persistence.Migrations
{
    ...
    [Migration("20251224082803_OrderOrderTotalCostNullableUpdate")]
    partial class OrderOrderTotalCostNullableUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.Address", b =>
                {
                    ...
                    b.HasIndex("UserId", "AddressName")
                        .IsUnique()
                        .HasFilter("[AddressName] IS NOT NULL");
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.AnswerVote", b =>
                {
                    ...
                    b.HasIndex("AnswerVoteUserId", "AnswerVoteAnswerId")
                        .IsUnique()
                        .HasFilter("[AnswerVoteUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.CommentVote", b =>
                {
                    ...
                    b.HasIndex("CommentVoteUserId", "CommentVoteCommentId")
                        .IsUnique()
                        .HasFilter("[CommentVoteUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.CouponProductType", b =>
                {
                    ...
                    b.HasIndex("CouponId", "ProductTypeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.CouponUsage", b =>
                {
                    ...
                    b.HasIndex("CouponUsageOrderId", "CouponUsageCouponId")
                        .IsUnique();
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.ProductAttribute", b =>
                {
                    ...
                    b.HasIndex("AttributeDefinitionId", "ProductId")
                        .IsUnique();
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.ProductRate", b =>
                {
                    ...
                    b.HasIndex("ProductRateUserId", "ProductRateProductId")
                        .IsUnique()
                        .HasFilter("[ProductRateUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("PCStore.Domain.Entities.ProductTypeAttribute", b =>
                {
                    ...
                    b.HasIndex("AttributeDefinitionId", "ProductTypeId")
                        .IsUnique();
